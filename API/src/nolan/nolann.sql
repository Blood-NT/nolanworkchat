...
--
-- Host: localhost    Database: nolanworkchat
-- ------------------------------------------------------
...
CREATE TABLE `job` (
  ...
  `jobnote` varchar(500) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `leaderid` (`leaderid`),
  KEY `adminid` (`adminid`),
  CONSTRAINT `job_ibfk_1` FOREIGN KEY (`leaderid`) REFERENCES `users` (`id`),
  CONSTRAINT `job_ibfk_2` FOREIGN KEY (`adminid`) REFERENCES `users` (`id`)
...
CREATE TABLE `task` (
  ...
  KEY `memid` (`memid`),
  KEY `jobid` (`jobid`),
  CONSTRAINT `taskid_ibfk_1` FOREIGN KEY (`leaderid`) REFERENCES `users` (`id`),
  CONSTRAINT `taskid_ibfk_2` FOREIGN KEY (`memid`) REFERENCES `users` (`id`),
  CONSTRAINT `taskid_ibfk_4` FOREIGN KEY (`jobid`) REFERENCES `job` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `taskmessages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `taskmessages` (
  ...
  KEY `taskid` (`taskid`),
  KEY `sender` (`sender`),
  CONSTRAINT `taskmessages_ibfk_1` FOREIGN KEY (`taskid`) REFERENCES `task` (`id`),
  CONSTRAINT `taskmessages_ibfk_2` FOREIGN KEY (`sender`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `taskmessages`
--

LOCK TABLES `taskmessages` WRITE;
/*!40000 ALTER TABLE `taskmessages` DISABLE KEYS */;
/*!40000 ALTER TABLE `taskmessages` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-12 11:56:17
